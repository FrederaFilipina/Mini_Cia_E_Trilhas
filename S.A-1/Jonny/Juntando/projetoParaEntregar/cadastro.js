...
function abrirBotaoPerfil() {
    const abrirBotaoPerfil = document.querySelectorAll(".abrir-modalPerfil");
    abrirBotaoPerfil.forEach((button) => {
        button.addEventListener("click", () => {
            const modalId = button.getAttribute("data-modalPerfil"); // <- CORRETO AQUI
...
function fecharBotaoPerfil() {
    const fecharBotaoPerfil = document.querySelectorAll(".fechar-modalMeuPerfil")
    fecharBotaoPerfil.forEach((button) => {
        button.addEventListener("click", () => {
            const modalId = button.getAttribute("data-modalPerfil")
            const modal = document.getElementById(modalId)
            modal.close()
        })
    })
...
function mostrarDadosUsuario() {
  ...
  const informacoesPerfil = document.getElementById("perfil")
    ...
    if (usuario === undefined) {
        ...
        informacoesPerfil.innerHTML = `<p>Nome : ${usuario.nomeUsuario}<p/>
    ...
    //     informacoesPerfil.addEventListener("click", (editar) => {
